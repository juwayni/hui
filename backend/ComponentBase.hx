...
import haxe_ui.backend.ComponentSurface;
import haxe_ui.behaviours.Behaviours;
import haxe_ui.behaviours.DataBehaviour;
import haxe_ui.behaviours.DefaultBehaviour;
import haxe_ui.behaviours.ValueBehaviour;
import haxe_ui.core.Component;
import haxe_ui.core.IClonable;
import haxe_ui.core.IComponentContainer;
import haxe_ui.core.IEventDispatcher;
import haxe_ui.core.IScroller;
import haxe_ui.core.ImageDisplay;
import haxe_ui.core.Screen;
import haxe_ui.core.TextDisplay;
import haxe_ui.core.TextInput;
import haxe_ui.events.EventType;
import haxe_ui.events.Events;
import haxe_ui.events.KeyboardEvent;
import haxe_ui.events.MouseEvent;
import haxe_ui.events.UIEvent;
import haxe_ui.geom.Point;
import haxe_ui.geom.Rectangle;
import haxe_ui.layouts.Layout;
import haxe_ui.styles.Style;
import haxe_ui.tooltips.ToolTipManager;
import haxe_ui.util.EventMap;
import haxe_ui.util.FunctionArray;
import haxe_ui.util.Variant;
import haxe_ui.validation.InvalidationFlags;
import haxe_ui.validation.ValidationManager;

@:build(haxe_ui.macros.Macros.buildBehaviours())
@:autoBuild(haxe_ui.macros.Macros.buildBehaviours())
@:build(haxe_ui.macros.Macros.build())
@:autoBuild(haxe_ui.macros.Macros.build())
class ComponentBase extends ComponentSurface implements IClonable<ComponentBase> implements IEventDispatcher<UIEvent> implements IComponentContainer {
    ...
    **/
     ...
     */
     ...
     @:allow(haxe_ui.layouts.Layout)
     @:allow(haxe_ui.core.Screen)
     ...
     private function set_width(value:Float): #if Float Void #else Float #end {
         ...
         if (value == haxe_ui.util.MathUtil.MIN_INT) {
             _width = null;
             componentWidth = null;
         } else {
             _width = value;
