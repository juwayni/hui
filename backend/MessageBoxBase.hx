...
class MessageBoxBase extends Dialog {
    ...
    public var iconImage:haxe_ui.components.Image;
    public var messageLabel:haxe_ui.components.Label;
    //#end
    ...
    public function new() {
        ...
        var hbox = new haxe_ui.containers.HBox();
        hbox.percentWidth = 100;
        hbox.styleString = "spacing:10px;";
        addComponent(hbox);

        iconImage = new haxe_ui.components.Image();
        iconImage.id = "iconImage";
        hbox.addComponent(iconImage);

        messageLabel = new haxe_ui.components.Label();
