...
class XMLParser extends ComponentParser {
    ...
    public override function parse(data:String, resourceResolver:ResourceResolver = null, fileName:String = null):ComponentInfo {
        ...
        } catch (e:haxe_ui.parsers.ui.ComponentParser.ComponentParserException) {
            throw new haxe_ui.parsers.ui.ComponentParser.ComponentParserException('while parsing "${e.fileName}": ${e.original.message}', e.fileName, e.original, e);
        } catch (e:Exception) {
            throw new haxe_ui.parsers.ui.ComponentParser.ComponentParserException('while parsing "${fileName}": ${e.message}', fileName, e, e);
        }
