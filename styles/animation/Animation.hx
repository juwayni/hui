package haxe_ui.styles.animation;

import haxe_ui.constants.AnimationDirection;
import haxe_ui.constants.AnimationFillMode;
import haxe_ui.styles.EasingFunction;
import haxe_ui.styles.elements.AnimationKeyFrames;
import haxe_ui.util.StyleUtil;
...
@:access(haxe_ui.styles.animation.AnimationOptions)
class Animation {
    //***********************************************************************************************************
    // Helpers
    //***********************************************************************************************************
    ...
    **/
    ...
    /**
     ...
     @see `haxe_ui.constants.AnimationDirection`
    **/
    ...
    **/
    ...
    /**
     ...
     @see `haxe_ui.styles.EasingFunction`
    **/
    ...
    /**
     ...
     @see `haxe_ui.constants.AnimationFillMode`
    **/
