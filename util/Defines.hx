...
class Defines {
    ...
    public static function popuplate() {
        ...
        _map = new Map<String, String>();
        if (haxe_ui.core.Platform.instance.isWindows) {
            set("windows", "1");
        } else if (haxe_ui.core.Platform.instance.isLinux) {
            set("linux", "1");
        } else if (haxe_ui.core.Platform.instance.isMac) {
            set("mac", "1");
        }
