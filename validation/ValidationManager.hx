package haxe_ui.validation;

import haxe_ui.core.Component;
import haxe_ui.events.UIEvent;
import haxe_ui.events.ValidationEvent;
...
class ValidationManager {
    ...
    public function process() {
        ...
        #if profile_validation
        var start = haxe_ui.core.Platform.instance.perf();
        #end
        ...
        var end = haxe_ui.core.Platform.instance.perf();
        var delta = end - start;
        ...
        trace("InvalidationManager.process: current=" + haxe_ui.util.MathUtil.round(delta, 2) + "ms, avg=" + haxe_ui.util.MathUtil.round(_profileAvg, 2) + "ms, count=" + _profileCount + ", min=" + haxe_ui.util.MathUtil.round(_profileMin, 2) + "ms, max=" + haxe_ui.util.MathUtil.round(_profileMax, 2) + "ms, tot=" + haxe_ui.util.MathUtil.round(_profileTot, 2) + "ms");
        #end
