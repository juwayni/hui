...
import haxe_ui.behaviours.LayoutBehaviour;
import haxe_ui.components.Column;
import haxe_ui.components.Label;
import haxe_ui.components.VerticalScroll;
import haxe_ui.constants.SelectionMode;
import haxe_ui.containers.ScrollView.ScrollViewBuilder;
import haxe_ui.containers.ScrollView.ScrollViewEvents;
...
import haxe_ui.data.transformation.NativeTypeTransformer;
import haxe_ui.events.ActionEvent;
import haxe_ui.events.ItemEvent;
import haxe_ui.events.MouseEvent;
import haxe_ui.events.ScrollEvent;
import haxe_ui.events.SortEvent;
import haxe_ui.events.UIEvent;
import haxe_ui.geom.Rectangle;
import haxe_ui.geom.Size;
import haxe_ui.layouts.LayoutFactory;
import haxe_ui.layouts.VerticalVirtualLayout;
...
private class Builder extends ScrollViewBuilder {
    ...
    @:access(haxe_ui.layouts.VerticalVirtualLayout)
