...
import haxe_ui.components.Scroll;
import haxe_ui.components.VerticalScroll;
import haxe_ui.constants.MouseButton;
import haxe_ui.constants.Priority;
import haxe_ui.constants.ScrollMode;
import haxe_ui.constants.ScrollPolicy;
...
import haxe_ui.layouts.ScrollViewLayout;
import haxe_ui.styles.Style;
import haxe_ui.util.Timer;
...
@:dox(hide) @:noCompletion
@:access(haxe_ui.core.Component)
@:access(haxe_ui.containers.ScrollViewBuilder)
...
class ScrollViewEvents extends haxe_ui.events.Events {
    private var _scrollview:ScrollView;
...
//***********************************************************************************************************
@:dox(hide) @:noCompletion
@:allow(haxe_ui.containers.ScrollView)
@:access(haxe_ui.core.Component)
