...
import haxe_ui.components.TabBar;
...
@:access(haxe_ui.containers.Builder)
...
@:dox(hide) @:noCompletion
@:access(haxe_ui.core.Component)
@:access(haxe_ui.components.Builder)
...
@:dox(hide) @:noCompletion
@:access(haxe_ui.core.Component)
@:access(haxe_ui.components.TabViewBuilder)
@:access(haxe_ui.containers.Builder)
...
private class Builder extends CompositeBuilder {
    ...
    public override function applyStyle(style:Style) {
        ...
        haxe_ui.macros.ComponentMacros.cascadeStylesTo("tabview-tabs", [
