...
class NavigationMacros {
    ...
    public static macro function buildNavigatableView():Array<Field> {
        ...
        if (navigationSubDomain != null && navigationSubDomain.trim().length > 0) {
            BackendMacros.additionalExprs.push(macro haxe_ui.navigation.NavigationManager.instance.subDomain = $v{navigationSubDomain});
        }
        ...
        if (routeDetailsMeta != null) {
            ...
            if (routePathExpr != null) {
                ...
                parts.push("new");
                routeExpr = macro haxe_ui.navigation.NavigationManager.instance.registerRoute($routePathExpr, {
                    viewCtor: $p{parts},
