...
class LayoutMacros {
    ...
    static function buildClonable(builder:ClassBuilder) {
        var useSelf:Bool = (builder.fullPath == "haxe_ui.layouts.Layout");
