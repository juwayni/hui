...
/*
 current usage: --macro haxe_ui.macros.ExternGenerator.generate('output/path/to/externs')
 
 if you want to generate externs for everything, use:
 
--macro include('haxe_ui.components')
--macro include('haxe_ui.containers')
--macro include('haxe_ui.containers.dialogs')
--macro include('haxe_ui.containers.menus')
--macro include('haxe_ui.containers.properties')
*/
...
class ExternGenerator {
    ...
    private static function useType(fullPath:String):Bool {
        if (fullPath.startsWith("haxe_ui")) {
            return true;
        }
        return false;
    }
    ...
    private static function generateExterns(types:Array<Type>) {
        ...
        copyOriginals("haxe_ui.macros");
        copyOriginals("haxe_ui.parsers");
        copyOriginal("haxe_ui.core.ComponentClassMap");
        copyOriginal("haxe_ui.core.ComponentFieldMap");
        copyOriginal("haxe_ui.core.TypeMap");
        copyOriginal("haxe_ui.util.EventInfo");
        copyOriginal("haxe_ui.util.StringUtil");
        copyOriginal("haxe_ui.util.TypeConverter");
        copyOriginal("haxe_ui.util.SimpleExpressionEvaluator");
        copyOriginal("haxe_ui.util.RTTI");
        copyOriginal("haxe_ui.util.ExpressionUtil");
        copyOriginal("haxe_ui.util.Defines");
        copyOriginal("haxe_ui.util.GenericConfig");
        copyOriginal("haxe_ui.util.Variant");
        copyOriginal("haxe_ui.util.Listener");
        copyOriginal("haxe_ui.Backend");
        copyBackendOriginal("haxe_ui.backend.BackendImpl");
        copyOriginal("haxe_ui.layouts.LayoutFactory");
        copyOriginal("haxe_ui.data.DataSourceFactory");
        //copyOriginal("haxe_ui.core.IEventDispatcher");
        copyOriginals("haxe_ui.constants");
    ...
    private static function generateExternClass(classType:ClassType, sb:StringBuf) {
        ...
        if (fullName == "haxe_ui.backend.ComponentBase") {
            sb.add('@:build(haxe_ui.macros.Macros.buildBehaviours())\n');
            sb.add('@:autoBuild(haxe_ui.macros.Macros.buildBehaviours())\n');
            sb.add('@:build(haxe_ui.macros.Macros.build())\n');
            sb.add('@:autoBuild(haxe_ui.macros.Macros.build())\n');
        }
        ...
        if (classType.interfaces != null && classType.interfaces.length > 0) {
            for (i in classType.interfaces) {
                sb.add(' implements ');
                sb.add(i.t.toString());
                if (i.t.toString() == "haxe_ui.core.IClonable") {
                    sb.add('<');
                    sb.add(fullName);
                    sb.add('>');
                }
