...
import haxe_ui.Preloader.PreloadItem;
import haxe_ui.Preloader;
import haxe_ui.backend.AppImpl;
...
class HaxeUIApp extends AppImpl {
    ...
    private override function init(onReady:Void->Void, onEnd:Void->Void = null) {
        ...
        if (Toolkit.backendProperties.getProp("haxe_ui.theme") != null && Toolkit.theme == "default") {
            Toolkit.theme = Toolkit.backendProperties.getProp("haxe_ui.theme");
        }
