...
/**
    ...
    | -------------- | -------------------------- | ------------ | -------------------------------------- |
    | `button-label` | `haxe_ui.components.Label` | `.label`     | The text of the button (if applicable) |
    | `button-icon`  | `haxe_ui.components.Image` | `.icon`      | The icon of the button (if applicable) |
    ...
    @see haxe_ui.containers.ButtonBar
**/
...
@:dox(hide) @:noCompletion
@:access(haxe_ui.core.Component)
@:access(haxe_ui.components.ButtonEvents)
...
//***********************************************************************************************************
@:dox(hide) @:noCompletion
class ButtonEvents extends haxe_ui.events.Events {
...
class ButtonBuilder extends CompositeBuilder {
    ...
    public override function applyStyle(style:Style) {
        ...
        haxe_ui.macros.ComponentMacros.cascadeStylesTo("button-label", [
            color, fontName, fontSize, cursor, textAlign, fontBold, fontUnderline, fontItalic
        ], false);
        haxe_ui.macros.ComponentMacros.cascadeStylesTo("button-icon", [cursor], false);
