...
import haxe_ui.behaviours.InvalidatingBehaviour;
import haxe_ui.constants.HorizontalAlign;
import haxe_ui.constants.ScaleMode;
import haxe_ui.constants.VerticalAlign;
...
import haxe_ui.loaders.image.ImageLoader;
import haxe_ui.styles.Style;
import haxe_ui.util.GUID;
...
//***********************************************************************************************************
@:dox(hide) @:noCompletion
@:access(haxe_ui.components.Image)
