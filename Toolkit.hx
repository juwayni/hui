...
import haxe_ui.backend.ToolkitOptions;
...
import haxe_ui.macros.BackendMacros;
import haxe_ui.macros.ModuleMacros;
import haxe_ui.macros.NativeMacros;
import haxe_ui.styles.CompositeStyleSheet;
import haxe_ui.themes.ThemeManager;
import haxe_ui.util.GenericConfig;
import haxe_ui.util.Properties;
...
class Toolkit {
    ...
    public static function build() {
        ...
        buildBackend();
        haxe_ui.locale.LocaleManager.instance.init();
        _built = true;
    }
