...
import haxe_ui.backend.ComponentImpl;
import haxe_ui.events.AnimationEvent;
...
import haxe_ui.layouts.DelegateLayout;
import haxe_ui.layouts.Layout;
import haxe_ui.locale.LocaleManager;
import haxe_ui.styles.DirectiveHandler;
import haxe_ui.styles.Parser;
import haxe_ui.styles.Style;
import haxe_ui.styles.StyleSheet;
import haxe_ui.styles.animation.Animation;
import haxe_ui.styles.elements.AnimationKeyFrames;
import haxe_ui.util.Color;
import haxe_ui.util.ComponentUtil;
import haxe_ui.util.MathUtil;
import haxe_ui.util.StringUtil;
import haxe_ui.util.Variant;
import haxe_ui.validation.IValidating;
 ...
 */
@:allow(haxe_ui.backend.ComponentImpl)
class Component extends ComponentImpl
    #if haxeui_allow_drag_any_component
    implements haxe_ui.extensions.Draggable
    #end
