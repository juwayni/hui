...
class SettingsManager {
    ...
    private function getPersister():ISettingsPersister {
        ...
        _persister = new haxe_ui.core.SettingsManager.LocalStorageSettingsPersister();

        #elseif sys

        _persister = new haxe_ui.core.SettingsManager.FileSettingsPersister();

        #else

        _persister = new haxe_ui.core.SettingsManager.NoOpSettingsPersister();
